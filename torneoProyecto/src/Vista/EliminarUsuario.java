...
public class EliminarUsuario extends javax.swing.JFrame {
    ...
    public void llenarFiltro(String filtro){
        try {
            ...
            String[] titulos={"idUsuario","nombreUsuario","passw","tipoUsuario"};
            String sql ="SELECT * FROM Usuario WHERE nombreUsuario LIKE '%"+ filtro + "%'";
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtPswd, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(2, 2, 2)
         ...
         if(evt.getButton()== 1){
            ...
            try {
                ...
                rs.next();
                   ...
                   txtPswd.setText(rs.getString("passw"));
                   txtTipo.setText(rs.getString("tipoUsuario"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Conexion conn= new Conexion();
            Connection con = conn.getConexion();
            String sql="DELETE FROM Usuario WHERE idUsuario="+ jTable1.getValueAt(fila, 0);
            Statement ps= con.createStatement();
